...
It supports *offline operation*, *digital authonomy* and interoperability: It is free and open source software. It has an open REST API for interoperability. An instance runs on aprs.no by the Norwegian Radio Relay League.  
